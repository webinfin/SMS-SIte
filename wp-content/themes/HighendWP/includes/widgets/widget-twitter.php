		...
		?>
					...
					<div id="tweets_<?php echo $args['widget_id']; ?>">
						<ul class="hb-tweet-list <?php echo $skin; ?>">
							...
							<span class="tweet-time"><a href="https://twitter.com/<?php echo $tweet->user->screen_name; ?>/statuses/<?php echo $tweet->id_str; ?>"><i class="hb-moon-twitter"></i><?php echo $timeAgo; ?></a></span>
							<?php endforeach; ?>
						</ul>
					</div>

					<p><?php _e('Follow ', 'hbthemes'); ?><a href="https://twitter.com/<?php echo $tweet->user->screen_name; ?>" target="_blank">@<?php echo $tweet->user->screen_name; ?></a></p>
		<?php 
		echo $after_widget;
	}} else {
