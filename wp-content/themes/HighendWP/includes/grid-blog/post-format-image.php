...
?>
<!-- BEGIN .hentry -->
<article id="post-<?php the_ID(); ?>" <?php if ( has_post_thumbnail() ) post_class('image-post-type with-featured-image ' . $blog_grid_column_class ); else post_class('image-post-type ' . $blog_grid_column_class ); ?> itemscope itemtype="http://schema.org/BlogPosting">
