<!-- BEGIN .hentry -->
<article id="post-<?php the_ID(); ?>" <?php if ( vp_metabox('post_format_settings.hb_video_post_format.0.hb_video_format_link') ) post_class('audio-post-format with-featured-image'); else post_class('image-post-type'); ?> itemscope itemtype="http://schema.org/BlogPosting">
