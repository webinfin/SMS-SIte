...
var IFrameDialog = {
	...
	insert : function insertButton(ed) {
		...
		var image_caption = jQuery('#image-caption').val();
...
<form action="/" method="get" accept-charset="utf-8">
        ...
        <div class="form-section clearfix">
            <label for="image-caption">Image Caption.<br/><small>Add optional image caption.</small></label>
            <input type="text" name="image-caption" id="image-caption" placeholder="Example: Image Caption"></textarea>
        </div>
