                        ...
                        <a href="<?php echo get_bloginfo ('url') ?>" class="image-logo">
							...
							<?php 
								if ( !is_front_page() && !is_home() ) {
									?>	
									<img src="<?php echo hb_options('hb_logo_option_retina');?>" width="318" height="72"  class="default jj retinalogo" alt="<?php echo $site_name; ?>"/>
								<?php
								}	
								else {
											?>
									<img src="<?php echo $logo_url; ?>" width="318" height="72" class="default mainlogo" alt="<?php echo $site_name; ?>"/>
									 <img src="<?php echo hb_options('hb_logo_option') ?>" width="318" height="72" class="sticky-logo" alt="<?php echo $site_name; ?>" />
								<?php
								}
...
<?php } ?>
                    ...
                    <nav class="main-navigation <?php echo $menu_skin_class; echo $menu_effect; echo ' ' . hb_options('hb_main_navigation_color'); ?> clearfix"<?php echo $regular_header_height; ?> role="navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
                        ...
                        <div class="top-get-btn">
                           <a class="get-ban-btn" target="_blank" href="http://login.showmarketingsystems.com/login.jsf"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2017/10/get-started.png"> Log In </a>
                            </div>
                        <!-- END #fancy-serach -->
                        <?php } ?>
                        ...
                        <a href="#" id="show-nav-menu-ai"><i class="icon-bars"></i></a>
                        <?php } ?>
