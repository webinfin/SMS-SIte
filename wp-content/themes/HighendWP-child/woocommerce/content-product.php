...
<div <?php post_class( $classes ); ?>>
	...
	<div class="hb-product-meta">
		...
		<div class="hb-woo-product-details">
			...
			<div class="woo-cats"><?php //echo $product->get_categories( ', ', '<span class="hb-woo-shop-cats">' . _n( '', '', $size, 'woocommerce' ) . ' ', '</span>' ); ?><?php
			if(get_post_meta($post->ID,'_model_text_field', true)): ?>
				<span class="model">Model: <?php echo get_post_meta($post->ID,'_model_text_field', true); ?></span>
			<?php endif; ?>
			...
			<a class="more_option" href="<?php the_permalink(); ?>">See More Options</a>
			
			<?php get_star_rating(); ?>
			<div class="ship"><?php /* $shipclass = $_product->get_shipping_class();  */
