...
function woof_init_search_form() {
    ...
    //***
    jQuery('ul.woof_childs_list').parent('li').addClass('woof_childs_list_li');	jQuery('ul.woof_childs_list').parent('li').addClass('mainclass2');
...
function woof_init_toggles() {    jQuery('.woof_front_toggle').life('click', function () {
...
function woof_supports_html5_storage() {
  try {
	...
	jQuery('.woof_block_html_items').find('ul li').each(function(){	if(jQuery(this).find('a').hasClass('woof_childs_list_opener')){		jQuery(this).find('div.icheckbox_flat-blue').css('display','none');		}else{		jQuery(this).find('div.icheckbox_flat-blue').css('display','block');		}	});
