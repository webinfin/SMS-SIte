...
<div class="woof_submit_search_form_container resetbtnlink"><button class="button woof_reset_search_form" data-link="">Clear Filters</button></div>
		    <?php
...
//+++
	...
	public function woof_sort_terms_is_checked($terms = array(), $type = "checkbox") {
		...
		/* echo "<pre>"; print_r($temp_term); die; */
